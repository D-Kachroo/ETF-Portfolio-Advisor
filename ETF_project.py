...
# It is designed to be user-friendly with text, visualizations, formulas, and metrics to help make informed investment decisions.
...
# --------------------------------------------------------------------------------------------------------------------------------------
# Function: Front-end Streamlit Application (User Interface) 
# --------------------------------------------------------------------------------------------------------------------------------------
