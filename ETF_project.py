...
# It utilizes Streamlit for the frontend interface, yfinance to fetch real-time ticker data, and PyPortfolioOpt to optimize ETF portfolios.
...
# --------------------------------------------------------------------------------------------------------------------------------------
# Loads Metadata for ETFs from a Local CSV File (etf_list_validated.csv)
# --------------------------------------------------------------------------------------------------------------------------------------
...
def show_correlation_heatmap(returns):
    ...
    st.subheader("📌 Correlation Heatmap (-1 = 👍 to +1 = 👎)")
    fig, ax = plt.subplots()
...
def main():
    ...
    st.title("💼 Full-Stack Investment Portfolio Advisor (ETFs) - By: David K.")
